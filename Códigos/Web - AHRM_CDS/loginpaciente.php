<?php
    ...
    # Verifica se há cookies setados, pois se houver redirecionará para o index paciente
...
<body style="background-image: url('img/img-login1.jpg'); background-repeat: no-repeat; background-position: center top;">
    ...
    <div id="wrapper">
        ...
        <ol class="breadcrumb" style="background-color: rgba(0, 0, 0, 0.7); width: 80%; position: relative; top: 50px;">
            ...
            <li class="active" style="font-size: 16pt; color: white;">
                <i class="fa fa-user" style="font-size: 30pt; color: blue;"></i> Login do Paciente
            </li>

            <br /> <br />

            <form name="formLoginPaciente" method="post" role="form" action="login/autenticar_paciente.php">
                ...
                <div style="text-align: right;">
                    ...
                    <a href="cadpaciente.php" id="cad" style="font-size: 14pt;">Ainda não é um usuário? Cadastre-se!</a>
