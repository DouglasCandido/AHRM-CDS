...
<head>
    ...
    <title>AHRM CDS - Cadastro de Médico</title>
...
<body>
                    ...
                    <div class="col-lg-10">
                        ...
                        <ol class="breadcrumb" style="background-color: rgba(0, 0, 0, 0.8); position: relative; width: 100%; height: 100%;">
                            <li class="active" style="font-size: 16pt; color: white;">
                                <i class="fa fa-user-md" style="font-size: 30pt; color: blue;"></i> Cadastro de Médico
                            </li>

                            <br /> <br />

                        <form name="cadMedicoForm" method="post" role="form" enctype="multipart/form-data" action="cadastro/cadastro_medico.php">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label style="font-size: 12pt; color: white;">CRM</label>
                                <input class="form-control" minlenght="6" maxlength="6" name="cadCRM" placeholder="Digite o seu CRM (ex: uf0000)" required>
                                <!-- onkeypress="mascara(this,'')" -->
                            </div>
    ...
    <footer style='position: absolute; top: 1400px; background-color: #CCC'>
            <div class='container'>
                <div class='row'>
