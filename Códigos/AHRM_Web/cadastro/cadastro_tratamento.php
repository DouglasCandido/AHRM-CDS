<?php 
    ...
    # Biblioteca utilizada para transformar o formulario preenchido em PDF
    ...
    # Recuperando os dados necessários para gerar o PDF do tratamento:
    ...
    $descricao = $_POST['cadDescricaoTratamento'];
	...
	<head>
	    ...
	    <title>AHRM CDS - Tratamento médico para controle e alívio de sintomas de cardiopatia</title>
	...
	<body>
		<div class='brand' style='text-align: center;'> <img src='../img/img-logo.png'> </div>
	        ...
	        <h1 class='page-header' style='text-align: center;'> Tratamento médico para controle e alívio de sintomas de cardiopatia </h1>
                            ...
                            <div class='col-lg-6' style='float: left; right: 150px;'>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='div_info'>
                                        ...
                                        <h3> Informações sobre o tratamento: </h3>
                                        <span class='span_info'> Data de submissão do tratamento:" . " " . $data_do_tratamento . "</span> <br />
                                        <span class='span_info'> Descrição do tratamento:" . " " . $descricao. "</span> <br />
